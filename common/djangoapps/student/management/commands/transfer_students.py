    ...
    def handle(self, *args, **options):  # pylint: disable=unused-argument
        ...
        for user in source_students:
            with transaction.commit_on_success():
                ...
                CourseEnrollment.unenroll(user, source_key, emit_unenrollment_signal=False)
                ...
                for dest_key in dest_keys:
                    if CourseEnrollment.is_enrolled(user, dest_key):
                        ...
                        if not old_is_active:
                            new_enrollment.update_enrollment(is_active=False, emit_unenrollment_signal=False)
